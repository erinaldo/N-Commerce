...
namespace Presentacion.Core.Cliente
{
    public partial class ClienteLookUp : FormLookUp
    {
        ...
        public ClienteLookUp(IPersonaServicio personaServicio)
        {
            InitializeComponent();
        ...
        {
            var clientes = (List<ClienteDto>)_personaServicio.Obtener(typeof(ClienteDto), !string.IsNullOrEmpty(cadenaBuscar) ? cadenaBuscar : string.Empty);

            dgv.DataSource = clientes.Where(x => x.Dni != "99999999").ToList();
