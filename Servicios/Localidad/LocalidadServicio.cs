...
namespace Servicios.Localidad
{
    public class LocalidadServicio : ILocalidadServicio
    {
        ...
        {
            Expression<Func<Dominio.Entidades.Localidad, bool>> filtro =
                x => x.Descripcion.Contains(cadenaBuscar) || x.Departamento.Provincia.Descripcion.Contains(cadenaBuscar);
        ...
        public IEnumerable<LocalidadDto> ObtenerPorDepartamento(long departamentoId, bool mostrarTodos = false)
        {
            Expression<Func<Dominio.Entidades.Localidad, bool>> filtro = x => x.DepartamentoId == departamentoId;
