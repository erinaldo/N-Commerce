    ...
    public class DepartamentoServicio : IDepartamentoServicio
    {
        ...
        public IEnumerable<DtoBase> Obtener(string cadenaBuscar, bool mostrarTodos = false)
        {
            Expression<Func<Dominio.Entidades.Departamento, bool>> filtro =
                x => x.Descripcion.Contains(cadenaBuscar) || x.Provincia.Descripcion.Contains(cadenaBuscar);
        ...
        public IEnumerable<DepartamentoDto> ObtenerPorProvincia(long provinciaId, bool mostrarTodos= false)
        {
            Expression<Func<Dominio.Entidades.Departamento, bool>> filtro = x => x.ProvinciaId == provinciaId;
