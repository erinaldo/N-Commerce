...
namespace Dominio.Entidades
{
    ...
    public class Configuracion : EntidadBase
    {
        ...
        public bool EtiquetasPorPrecio { get; set; }
        public int CodigoBascula { get; set; }
        ...
        public virtual Deposito DepositoStockIdPorDefecto { get; set; }
        public virtual Deposito DepositoVentaIdPorDefecto { get; set; }
    }
}
