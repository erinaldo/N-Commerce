namespace Infraestructura.Migrations
{
    ...
    public partial class MapeoInicial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        EtiquetasPorPrecio = c.Boolean(nullable: false),
                        CodigoBascula = c.Int(nullable: false),
                        EstaEliminado = c.Boolean(nullable: false),
                        DepositoStockIdPorDefecto_Id = c.Long(),
                        DepositoVentaIdPorDefecto_Id = c.Long(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Deposito", t => t.DepositoStockIdPorDefecto_Id)
                .ForeignKey("dbo.Deposito", t => t.DepositoVentaIdPorDefecto_Id)
                .ForeignKey("dbo.ListaPrecio", t => t.ListaPrecioPorDefectoId)
                .ForeignKey("dbo.Localidad", t => t.LocalidadId)
                .Index(t => t.LocalidadId)
                .Index(t => t.ListaPrecioPorDefectoId)
                .Index(t => t.DepositoStockIdPorDefecto_Id)
                .Index(t => t.DepositoVentaIdPorDefecto_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Configuracion", "DepositoVentaIdPorDefecto_Id", "dbo.Deposito");
            DropForeignKey("dbo.Configuracion", "DepositoStockIdPorDefecto_Id", "dbo.Deposito");
            ...
            DropIndex("dbo.Configuracion", new[] { "DepositoVentaIdPorDefecto_Id" });
            DropIndex("dbo.Configuracion", new[] { "DepositoStockIdPorDefecto_Id" });
